...
### 5. Grounding Exercise (Stripe)

A mechanism to spawn platforms via Stripe CLI events.

- **[docs/grounding_exercise.md](file:///c:/Users/eqhsp/.gemini/antigravity/playground/ghost-void/docs/grounding_exercise.md)**: Full instructions.
